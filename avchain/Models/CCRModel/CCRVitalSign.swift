...
class CCRVitalSign: CCRModel {
    ...
    override func setData(_ dic: [AnyHashable : Any]) {
        ...
        if dic[Constants.DBKey.Testresult_Value] != nil { testResultValue.value = dic[Constants.DBKey.Testresult_Value] as? String }
        if dic[Constants.DBKey.Testresult_Unit] != nil { testResultUnit.value = dic[Constants.DBKey.Testresult_Unit] as? String }
    ...
    override init() {
        ...
        tableName = Constants.DBName.VitalSigns
    }
}
